...
default[:opsworks][:rack_stack][:start_command] = "bin/#{application} -d --pid run/#{application}.pid -l shared/log/#{application}.log"
default[:opsworks][:rack_stack][:stop_command] = "bin/#{application} -k -P run/#{application}.pid"
